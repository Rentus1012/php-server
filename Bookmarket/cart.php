            ...
            <div class="row align-items-md-stretch text-center">
                ...
                <div class="col-md-12">
                    <div class="p-5">
                        <table width="100%">
                            <tr>
                                <td align="left"><a href="./deleteCart.php?cartId=<?= $cartId ?>" calss="btn btn-danger">삭제하기</a></td>
                                <td align="right"><a href="./shippingInfo.php?cartId=<?= $cartId ?>" calss="btn btn-success">>주문하기</a></td>
                            </tr>
                        </table>
                    </div>
                    <div>
